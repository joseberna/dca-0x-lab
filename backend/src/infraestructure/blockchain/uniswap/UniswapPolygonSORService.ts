...
export class UniswapPolygonSORService {
    ...
    async getSORQuote(tokenIn: string, tokenOut: string, amountInWei: ethers.BigNumber) {
    ...
    async executeSwap(tokenIn: string, tokenOut: string, amountInWei: ethers.BigNumber) {
        try {
