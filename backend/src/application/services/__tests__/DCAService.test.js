...
describe('DCAService', () => {
    ...
    describe('createPlan', () => {
        it('should create a plan with valid parameters', async () => {
            ...
            const tx = await mockContract.createPlan('0x123...', '0x456...', '100000000', '10000000', 3600, 10);
            expect(tx.hash).toBe('0x123...');
            expect(mockContract.createPlan).toHaveBeenCalledWith('0x123...', '0x456...', '100000000', '10000000', 3600, 10);
        });
    });
